...
CREATE INDEX `fk_claims_members1_idx` ON `DCA`.`claims` (`members_id` ASC);
...
CREATE INDEX `fk_payments_members1_idx` ON `DCA`.`payments` (`members_id` ASC);
...
CREATE INDEX `fk_users_members1_idx` ON `DCA`.`users` (`members_id` ASC);
